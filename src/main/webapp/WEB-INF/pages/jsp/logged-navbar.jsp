        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <button type="button" id="my-account">
                    <img src="<c:url value="/resources/includes/img/emp-icon.png"/>" width="30px" />
                </button>
            </div>
            <div class="collapse navbar-collapse" id="navbar-home">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown hidden-xs acc-drop">
                        <a href="#" class="dropdown-toggle my-account" data-toggle="dropdown" role="button" aria-expanded="false"><img src="includes/img/emp-icon.png" width="30px" /></a>
