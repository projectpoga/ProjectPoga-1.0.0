...
ALTER TABLE TV_DATA.USERS  AUTO_INCREMENT = 501;
...
ALTER TABLE TV_DATA.USERS  AUTO_INCREMENT = 101;
...
ALTER TABLE TV_DATA.USERS  AUTO_INCREMENT = 5001;
...
CREATE TABLE TV_DATA.EMPLOYERDETAILS (
    ...
    EMP_CONTACTNUMBER int    NOT NULL ,
...
ALTER TABLE TV_DATA.USERS  AUTO_INCREMENT = 4001;
...
ALTER TABLE TV_DATA.USERS  AUTO_INCREMENT = 12001;
...
ALTER TABLE TV_DATA.USERS  AUTO_INCREMENT = 13001;
...
CREATE TABLE TV_DATA.JOBS (
	...
	EXPERIENCEREQUIRED decimal(2,1)    NULL ,
    STATUS int    NOT NULL ,
	CREATED_DATE TIMESTAMP    DEFAULT CURRENT_TIMESTAMP,
    CREATED_BY int    NULL ,
    MODIFIED_BY int    NULL ,
...
ALTER TABLE TV_DATA.USERS  AUTO_INCREMENT = 2001;
