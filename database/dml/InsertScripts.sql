...
#jobs
INSERT INTO TV_DATA.JOBS (CATEGORY_ID,EMPLOYER_ID, JOB_TITLE, SHORTDESC, LONGDESC, SALARY, SKILLSREQUIRED, REFERAL_AMOUNT, INTRO_AMOUNT, LOCATION_ID,EXPERIENCEREQUIRED,STATUS,SALARY) 
VALUES ((SELECT CATEGORY_ID FROM TV_DATA.CATEGORIES WHERE CATEGORYNAME = 'Application Development'),
        (SELECT EMPLOYER_ID FROM TV_DATA.EMPLOYER WHERE LOWER(EMP_USERNAME) = 'Ramana'),'Software Trainee','Software Trainee desc','The roles include development works',47000,'Core java, C, C++' 25000, 20000,
        (SELECT LOCATION_ID FROM TV_DATA.LOCATION WHERE LOWER(CITYNAME) = 'visakhapatnam'), 0, '1',25000);
INSERT INTO TV_DATA.JOBS (CATEGORY_ID,EMPLOYER_ID, JOB_TITLE, SHORTDESC, LONGDESC, SALARY, SKILLSREQUIRED, REFERAL_AMOUNT, INTRO_AMOUNT, LOCATION_ID,EXPERIENCEREQUIRED,STATUS,SALARY) 
VALUES ((SELECT CATEGORY_ID FROM TV_DATA.CATEGORIES WHERE CATEGORYNAME = 'Application Development'),
        (SELECT EMPLOYER_ID FROM TV_DATA.EMPLOYER WHERE LOWER(EMP_USERNAME) = 'siva'),'Sr.Java Developer','Java Developer','The roles include developing java projects', 65000,'Core java, J2EE, JSP, C, C++' 25000, 35000,
