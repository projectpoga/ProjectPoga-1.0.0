...
INSERT INTO TV_DATA.EMPLOYERDETAILS(EMPLOYER_ID, COMPANY_NAME, COMPANY_EMAILID, EMPLOYER_EMAILID, COMPANY_ADDRESS, CONTACTNUMBER, EMP_CONTACTNUMBER) 
    VALUES ((SELECT EMPLOYER_ID FROM TV_DATA.EMPLOYER WHERE LOWER(EMP_USERNAME) = 'manoj'), 'Ramuk Creative Curve','info@rcc.com', 'manoj@rcc.com', '#123-45, Miracle Towers, Chennai', '089125555', '94944852408');
